	...
	public class Files2 
	{
		...
		public static void deleteEngToSpan()
		{
			...
			String spanish = Translate.translateWord(1, english); // get the translation for the word to delete.
		 ...
		 */
		public static void translateFileEngToSpan() 
		{
			FileReader fileReader;
			BufferedReader bufferedReader;
			String nextLine;
			...
			try 
			{
				...
				while (nextLine != null) // Whilst the line is not blank.
				{
					...
					{
						String temp = Translation.translateWord(1, line[i]); // Translate the word.
		 ...
		 */
		public static void translateFileSpanToEng() 
		{
			FileReader fileReader;
			BufferedReader bufferedReader;
			String nextLine;
			...
			try 
			{
				...
				while (nextLine != null)
				{
					...
					{
						String temp = Translation.translateWord(2, line[i]);
